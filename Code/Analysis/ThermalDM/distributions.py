...
Produces the abundance plots as shown in Figure 1 of paper

To Note:

- Data should be stored in DarkBBN/Data. If not, get_data call below shoould be modified
- Outputs two pdfs "Nu_abundance_plot.pdf" and "EE_abundance_plot.pdf"
"""
...
if __name__ == '__main__':
	...
	for scenario in scenarios:
		...
		plt.savefig(scenario + '_abundance_plot.pdf')
